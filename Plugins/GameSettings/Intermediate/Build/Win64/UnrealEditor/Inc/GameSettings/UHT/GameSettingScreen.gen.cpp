...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameSettingScreen_ApplyChanges_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UGameSettingScreen, nullptr, "ApplyChanges", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080402, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingScreen_ApplyChanges_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGameSettingScreen_ApplyChanges_Statics::Function_MetaDataParams)},  };
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameSettingScreen_CancelChanges_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UGameSettingScreen, nullptr, "CancelChanges", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080402, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingScreen_CancelChanges_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGameSettingScreen_CancelChanges_Statics::Function_MetaDataParams)},  };
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameSettingScreen_NavigateToSetting_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UGameSettingScreen, nullptr, "NavigateToSetting", Z_Construct_UFunction_UGameSettingScreen_NavigateToSetting_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingScreen_NavigateToSetting_Statics::PropPointers), sizeof(Z_Construct_UFunction_UGameSettingScreen_NavigateToSetting_Statics::GameSettingScreen_eventNavigateToSetting_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080403, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingScreen_NavigateToSetting_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGameSettingScreen_NavigateToSetting_Statics::Function_MetaDataParams)},  };
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameSettingScreen_NavigateToSettings_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UGameSettingScreen, nullptr, "NavigateToSettings", Z_Construct_UFunction_UGameSettingScreen_NavigateToSettings_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingScreen_NavigateToSettings_Statics::PropPointers), sizeof(Z_Construct_UFunction_UGameSettingScreen_NavigateToSettings_Statics::GameSettingScreen_eventNavigateToSettings_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04480403, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UGameSettingScreen_NavigateToSettings_Statics::Function_MetaDataParams), Z_Construct_UFunction_UGameSettingScreen_NavigateToSettings_Statics::Function_MetaDataParams)},  };
...
struct Z_Construct_UClass_UGameSettingScreen_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UGameSettingScreen_ApplyChanges, "ApplyChanges" }, // 1495383668
		{ &Z_Construct_UFunction_UGameSettingScreen_AttemptToPopNavigation, "AttemptToPopNavigation" }, // 2074716763
		{ &Z_Construct_UFunction_UGameSettingScreen_CancelChanges, "CancelChanges" }, // 1340400929
		{ &Z_Construct_UFunction_UGameSettingScreen_GetSettingCollection, "GetSettingCollection" }, // 1532181687
		{ &Z_Construct_UFunction_UGameSettingScreen_HaveSettingsBeenChanged, "HaveSettingsBeenChanged" }, // 3777330824
		{ &Z_Construct_UFunction_UGameSettingScreen_NavigateToSetting, "NavigateToSetting" }, // 4122798870
		{ &Z_Construct_UFunction_UGameSettingScreen_NavigateToSettings, "NavigateToSettings" }, // 1543964948
		{ &Z_Construct_UFunction_UGameSettingScreen_OnSettingsDirtyStateChanged, "OnSettingsDirtyStateChanged" }, // 2094267619
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSettings_Source_Public_Widgets_GameSettingScreen_h__Script_GameSettings_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UGameSettingScreen, UGameSettingScreen::StaticClass, TEXT("UGameSettingScreen"), &Z_Registration_Info_UClass_UGameSettingScreen, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameSettingScreen), 2389195665U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSettings_Source_Public_Widgets_GameSettingScreen_h__Script_GameSettings_4032697217(TEXT("/Script/GameSettings"),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSettings_Source_Public_Widgets_GameSettingScreen_h__Script_GameSettings_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSettings_Source_Public_Widgets_GameSettingScreen_h__Script_GameSettings_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
