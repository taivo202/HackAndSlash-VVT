...
FClassRegistrationInfo Z_Registration_Info_UClass_USubtitleDisplayOptions;
UClass* USubtitleDisplayOptions::GetPrivateStaticClass()
{
	using TClass = USubtitleDisplayOptions;
	if (!Z_Registration_Info_UClass_USubtitleDisplayOptions.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("SubtitleDisplayOptions"),
			Z_Registration_Info_UClass_USubtitleDisplayOptions.InnerSingleton,
	...
	return Z_Registration_Info_UClass_USubtitleDisplayOptions.InnerSingleton;
}
UClass* Z_Construct_UClass_USubtitleDisplayOptions_NoRegister()
{
	return USubtitleDisplayOptions::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSubtitles_Source_Public_SubtitleDisplayOptions_h__Script_GameSubtitles_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_USubtitleDisplayOptions, USubtitleDisplayOptions::StaticClass, TEXT("USubtitleDisplayOptions"), &Z_Registration_Info_UClass_USubtitleDisplayOptions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USubtitleDisplayOptions), 1992029917U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSubtitles_Source_Public_SubtitleDisplayOptions_h__Script_GameSubtitles_172274115(TEXT("/Script/GameSubtitles"),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSubtitles_Source_Public_SubtitleDisplayOptions_h__Script_GameSubtitles_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSubtitles_Source_Public_SubtitleDisplayOptions_h__Script_GameSubtitles_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSubtitles_Source_Public_SubtitleDisplayOptions_h__Script_GameSubtitles_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSubtitles_Source_Public_SubtitleDisplayOptions_h__Script_GameSubtitles_Statics::EnumInfo));
// ********** End Registration *********************************************************************
