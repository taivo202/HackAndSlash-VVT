...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMediaSubtitlesPlayer_Stop_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UMediaSubtitlesPlayer, nullptr, "Stop", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020403, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaSubtitlesPlayer_Stop_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMediaSubtitlesPlayer_Stop_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_UMediaSubtitlesPlayer;
UClass* UMediaSubtitlesPlayer::GetPrivateStaticClass()
{
	using TClass = UMediaSubtitlesPlayer;
	if (!Z_Registration_Info_UClass_UMediaSubtitlesPlayer.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("MediaSubtitlesPlayer"),
			Z_Registration_Info_UClass_UMediaSubtitlesPlayer.InnerSingleton,
			StaticRegisterNativesUMediaSubtitlesPlayer,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UMediaSubtitlesPlayer.InnerSingleton;
}
UClass* Z_Construct_UClass_UMediaSubtitlesPlayer_NoRegister()
{
	return UMediaSubtitlesPlayer::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UMediaSubtitlesPlayer_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UMediaSubtitlesPlayer_BindToMediaPlayer, "BindToMediaPlayer" }, // 3071507771
		{ &Z_Construct_UFunction_UMediaSubtitlesPlayer_Play, "Play" }, // 1712194982
		{ &Z_Construct_UFunction_UMediaSubtitlesPlayer_SetSubtitles, "SetSubtitles" }, // 632309118
		{ &Z_Construct_UFunction_UMediaSubtitlesPlayer_Stop, "Stop" }, // 1033449841
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSubtitles_Source_Public_Players_MediaSubtitlesPlayer_h__Script_GameSubtitles_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMediaSubtitlesPlayer, UMediaSubtitlesPlayer::StaticClass, TEXT("UMediaSubtitlesPlayer"), &Z_Registration_Info_UClass_UMediaSubtitlesPlayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMediaSubtitlesPlayer), 406646608U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSubtitles_Source_Public_Players_MediaSubtitlesPlayer_h__Script_GameSubtitles_3654055221(TEXT("/Script/GameSubtitles"),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSubtitles_Source_Public_Players_MediaSubtitlesPlayer_h__Script_GameSubtitles_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSubtitles_Source_Public_Players_MediaSubtitlesPlayer_h__Script_GameSubtitles_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
