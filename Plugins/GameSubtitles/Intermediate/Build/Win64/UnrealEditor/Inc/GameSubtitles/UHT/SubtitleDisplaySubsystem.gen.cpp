...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FSubtitleFormat;
class UScriptStruct* FSubtitleFormat::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FSubtitleFormat.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FSubtitleFormat.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSubtitleFormat, (UObject*)Z_Construct_UPackage__Script_GameSubtitles(), TEXT("SubtitleFormat"));
	}
	return Z_Registration_Info_UScriptStruct_FSubtitleFormat.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FSubtitleFormat.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FSubtitleFormat.InnerSingleton, Z_Construct_UScriptStruct_FSubtitleFormat_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FSubtitleFormat.InnerSingleton;
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_USubtitleDisplaySubsystem;
UClass* USubtitleDisplaySubsystem::GetPrivateStaticClass()
{
	using TClass = USubtitleDisplaySubsystem;
	if (!Z_Registration_Info_UClass_USubtitleDisplaySubsystem.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("SubtitleDisplaySubsystem"),
			Z_Registration_Info_UClass_USubtitleDisplaySubsystem.InnerSingleton,
			StaticRegisterNativesUSubtitleDisplaySubsystem,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_USubtitleDisplaySubsystem.InnerSingleton;
}
UClass* Z_Construct_UClass_USubtitleDisplaySubsystem_NoRegister()
{
	return USubtitleDisplaySubsystem::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSubtitles_Source_Public_SubtitleDisplaySubsystem_h__Script_GameSubtitles_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FSubtitleFormat::StaticStruct, Z_Construct_UScriptStruct_FSubtitleFormat_Statics::NewStructOps, TEXT("SubtitleFormat"), &Z_Registration_Info_UScriptStruct_FSubtitleFormat, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSubtitleFormat), 511741015U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_USubtitleDisplaySubsystem, USubtitleDisplaySubsystem::StaticClass, TEXT("USubtitleDisplaySubsystem"), &Z_Registration_Info_UClass_USubtitleDisplaySubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USubtitleDisplaySubsystem), 550901793U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSubtitles_Source_Public_SubtitleDisplaySubsystem_h__Script_GameSubtitles_527360510(TEXT("/Script/GameSubtitles"),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSubtitles_Source_Public_SubtitleDisplaySubsystem_h__Script_GameSubtitles_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSubtitles_Source_Public_SubtitleDisplaySubsystem_h__Script_GameSubtitles_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSubtitles_Source_Public_SubtitleDisplaySubsystem_h__Script_GameSubtitles_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameSubtitles_Source_Public_SubtitleDisplaySubsystem_h__Script_GameSubtitles_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
