...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FLyraAccoladeDefinitionRow;
class UScriptStruct* FLyraAccoladeDefinitionRow::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FLyraAccoladeDefinitionRow.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FLyraAccoladeDefinitionRow.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAccoladeDefinitionRow, (UObject*)Z_Construct_UPackage__Script_ShooterCoreRuntime(), TEXT("LyraAccoladeDefinitionRow"));
	}
	return Z_Registration_Info_UScriptStruct_FLyraAccoladeDefinitionRow.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FLyraAccoladeDefinitionRow.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FLyraAccoladeDefinitionRow.InnerSingleton, Z_Construct_UScriptStruct_FLyraAccoladeDefinitionRow_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FLyraAccoladeDefinitionRow.InnerSingleton;
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_ULyraAccoladeDefinition;
UClass* ULyraAccoladeDefinition::GetPrivateStaticClass()
{
	using TClass = ULyraAccoladeDefinition;
	if (!Z_Registration_Info_UClass_ULyraAccoladeDefinition.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("LyraAccoladeDefinition"),
			Z_Registration_Info_UClass_ULyraAccoladeDefinition.InnerSingleton,
			StaticRegisterNativesULyraAccoladeDefinition,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_ULyraAccoladeDefinition.InnerSingleton;
}
UClass* Z_Construct_UClass_ULyraAccoladeDefinition_NoRegister()
{
	return ULyraAccoladeDefinition::GetPrivateStaticClass();
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULyraAccoladeDefinition_Statics::NewProp_AccoladeTags = { "AccoladeTags", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULyraAccoladeDefinition, AccoladeTags), Z_Construct_UScriptStruct_FGameplayTagContainer, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AccoladeTags_MetaData), NewProp_AccoladeTags_MetaData) }; // 2104890724
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Accolades_LyraAccoladeDefinition_h__Script_ShooterCoreRuntime_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FLyraAccoladeDefinitionRow::StaticStruct, Z_Construct_UScriptStruct_FLyraAccoladeDefinitionRow_Statics::NewStructOps, TEXT("LyraAccoladeDefinitionRow"), &Z_Registration_Info_UScriptStruct_FLyraAccoladeDefinitionRow, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraAccoladeDefinitionRow), 3574565384U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ULyraAccoladeDefinition, ULyraAccoladeDefinition::StaticClass, TEXT("ULyraAccoladeDefinition"), &Z_Registration_Info_UClass_ULyraAccoladeDefinition, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraAccoladeDefinition), 906609651U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Accolades_LyraAccoladeDefinition_h__Script_ShooterCoreRuntime_1048710703(TEXT("/Script/ShooterCoreRuntime"),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Accolades_LyraAccoladeDefinition_h__Script_ShooterCoreRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Accolades_LyraAccoladeDefinition_h__Script_ShooterCoreRuntime_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Accolades_LyraAccoladeDefinition_h__Script_ShooterCoreRuntime_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Accolades_LyraAccoladeDefinition_h__Script_ShooterCoreRuntime_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
