...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FAimAssistTargetOptions;
class UScriptStruct* FAimAssistTargetOptions::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FAimAssistTargetOptions.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FAimAssistTargetOptions.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAimAssistTargetOptions, (UObject*)Z_Construct_UPackage__Script_ShooterCoreRuntime(), TEXT("AimAssistTargetOptions"));
	}
	return Z_Registration_Info_UScriptStruct_FAimAssistTargetOptions.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FAimAssistTargetOptions.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FAimAssistTargetOptions.InnerSingleton, Z_Construct_UScriptStruct_FAimAssistTargetOptions_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FAimAssistTargetOptions.InnerSingleton;
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UAimAssistTaget;
UClass* UAimAssistTaget::GetPrivateStaticClass()
{
	using TClass = UAimAssistTaget;
	if (!Z_Registration_Info_UClass_UAimAssistTaget.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("AimAssistTaget"),
			Z_Registration_Info_UClass_UAimAssistTaget.InnerSingleton,
			StaticRegisterNativesUAimAssistTaget,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UAimAssistTaget.InnerSingleton;
}
UClass* Z_Construct_UClass_UAimAssistTaget_NoRegister()
{
	return UAimAssistTaget::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Input_IAimAssistTargetInterface_h__Script_ShooterCoreRuntime_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FAimAssistTargetOptions::StaticStruct, Z_Construct_UScriptStruct_FAimAssistTargetOptions_Statics::NewStructOps, TEXT("AimAssistTargetOptions"), &Z_Registration_Info_UScriptStruct_FAimAssistTargetOptions, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAimAssistTargetOptions), 872566557U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAimAssistTaget, UAimAssistTaget::StaticClass, TEXT("UAimAssistTaget"), &Z_Registration_Info_UClass_UAimAssistTaget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAimAssistTaget), 3421685443U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Input_IAimAssistTargetInterface_h__Script_ShooterCoreRuntime_619278045(TEXT("/Script/ShooterCoreRuntime"),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Input_IAimAssistTargetInterface_h__Script_ShooterCoreRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Input_IAimAssistTargetInterface_h__Script_ShooterCoreRuntime_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Input_IAimAssistTargetInterface_h__Script_ShooterCoreRuntime_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Input_IAimAssistTargetInterface_h__Script_ShooterCoreRuntime_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
