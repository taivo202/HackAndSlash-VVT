...
FClassRegistrationInfo Z_Registration_Info_UClass_UElimStreakProcessor;
UClass* UElimStreakProcessor::GetPrivateStaticClass()
{
	using TClass = UElimStreakProcessor;
	if (!Z_Registration_Info_UClass_UElimStreakProcessor.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("ElimStreakProcessor"),
			Z_Registration_Info_UClass_UElimStreakProcessor.InnerSingleton,
			StaticRegisterNativesUElimStreakProcessor,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UElimStreakProcessor.InnerSingleton;
}
UClass* Z_Construct_UClass_UElimStreakProcessor_NoRegister()
{
	return UElimStreakProcessor::GetPrivateStaticClass();
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UElimStreakProcessor_Statics::NewProp_ElimStreakTags_ValueProp = { "ElimStreakTags", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(0, nullptr) }; // 133831994
...
const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UElimStreakProcessor_Statics::NewProp_ElimStreakTags = { "ElimStreakTags", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UElimStreakProcessor, ElimStreakTags), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ElimStreakTags_MetaData), NewProp_ElimStreakTags_MetaData) }; // 133831994
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_MessageProcessors_ElimStreakProcessor_h__Script_ShooterCoreRuntime_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UElimStreakProcessor, UElimStreakProcessor::StaticClass, TEXT("UElimStreakProcessor"), &Z_Registration_Info_UClass_UElimStreakProcessor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UElimStreakProcessor), 1472284843U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_MessageProcessors_ElimStreakProcessor_h__Script_ShooterCoreRuntime_2649670899(TEXT("/Script/ShooterCoreRuntime"),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_MessageProcessors_ElimStreakProcessor_h__Script_ShooterCoreRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_MessageProcessors_ElimStreakProcessor_h__Script_ShooterCoreRuntime_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
