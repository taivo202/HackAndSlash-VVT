...
#include "Messages/ControlPointStatusMessage.h"
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FLyraControlPointStatusMessage;
class UScriptStruct* FLyraControlPointStatusMessage::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FLyraControlPointStatusMessage.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FLyraControlPointStatusMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraControlPointStatusMessage, (UObject*)Z_Construct_UPackage__Script_ShooterCoreRuntime(), TEXT("LyraControlPointStatusMessage"));
	}
	return Z_Registration_Info_UScriptStruct_FLyraControlPointStatusMessage.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FLyraControlPointStatusMessage.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FLyraControlPointStatusMessage.InnerSingleton, Z_Construct_UScriptStruct_FLyraControlPointStatusMessage_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FLyraControlPointStatusMessage.InnerSingleton;
}
// ********** End ScriptStruct FLyraControlPointStatusMessage **************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Messages_ControlPointStatusMessage_h__Script_ShooterCoreRuntime_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FLyraControlPointStatusMessage::StaticStruct, Z_Construct_UScriptStruct_FLyraControlPointStatusMessage_Statics::NewStructOps, TEXT("LyraControlPointStatusMessage"), &Z_Registration_Info_UScriptStruct_FLyraControlPointStatusMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraControlPointStatusMessage), 226444621U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Messages_ControlPointStatusMessage_h__Script_ShooterCoreRuntime_558423372(TEXT("/Script/ShooterCoreRuntime"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Messages_ControlPointStatusMessage_h__Script_ShooterCoreRuntime_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Messages_ControlPointStatusMessage_h__Script_ShooterCoreRuntime_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
