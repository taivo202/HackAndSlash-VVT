...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FPendingAccoladeEntry;
class UScriptStruct* FPendingAccoladeEntry::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FPendingAccoladeEntry.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FPendingAccoladeEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPendingAccoladeEntry, (UObject*)Z_Construct_UPackage__Script_ShooterCoreRuntime(), TEXT("PendingAccoladeEntry"));
	}
	return Z_Registration_Info_UScriptStruct_FPendingAccoladeEntry.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FPendingAccoladeEntry.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FPendingAccoladeEntry.InnerSingleton, Z_Construct_UScriptStruct_FPendingAccoladeEntry_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FPendingAccoladeEntry.InnerSingleton;
}
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULyraAccoladeHostWidget_CreateAccoladeWidget_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_ULyraAccoladeHostWidget, nullptr, "CreateAccoladeWidget", Z_Construct_UFunction_ULyraAccoladeHostWidget_CreateAccoladeWidget_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULyraAccoladeHostWidget_CreateAccoladeWidget_Statics::PropPointers), sizeof(LyraAccoladeHostWidget_eventCreateAccoladeWidget_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08420800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ULyraAccoladeHostWidget_CreateAccoladeWidget_Statics::Function_MetaDataParams), Z_Construct_UFunction_ULyraAccoladeHostWidget_CreateAccoladeWidget_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_ULyraAccoladeHostWidget;
UClass* ULyraAccoladeHostWidget::GetPrivateStaticClass()
{
	using TClass = ULyraAccoladeHostWidget;
	if (!Z_Registration_Info_UClass_ULyraAccoladeHostWidget.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("LyraAccoladeHostWidget"),
			Z_Registration_Info_UClass_ULyraAccoladeHostWidget.InnerSingleton,
			StaticRegisterNativesULyraAccoladeHostWidget,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_ULyraAccoladeHostWidget.InnerSingleton;
}
UClass* Z_Construct_UClass_ULyraAccoladeHostWidget_NoRegister()
{
	return ULyraAccoladeHostWidget::GetPrivateStaticClass();
}
struct Z_Construct_UClass_ULyraAccoladeHostWidget_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_ULyraAccoladeHostWidget_CreateAccoladeWidget, "CreateAccoladeWidget" }, // 2699565282
		{ &Z_Construct_UFunction_ULyraAccoladeHostWidget_DestroyAccoladeWidget, "DestroyAccoladeWidget" }, // 2711715741
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Accolades_LyraAccoladeHostWidget_h__Script_ShooterCoreRuntime_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FPendingAccoladeEntry::StaticStruct, Z_Construct_UScriptStruct_FPendingAccoladeEntry_Statics::NewStructOps, TEXT("PendingAccoladeEntry"), &Z_Registration_Info_UScriptStruct_FPendingAccoladeEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPendingAccoladeEntry), 4145025855U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ULyraAccoladeHostWidget, ULyraAccoladeHostWidget::StaticClass, TEXT("ULyraAccoladeHostWidget"), &Z_Registration_Info_UClass_ULyraAccoladeHostWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraAccoladeHostWidget), 907136831U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Accolades_LyraAccoladeHostWidget_h__Script_ShooterCoreRuntime_2689872873(TEXT("/Script/ShooterCoreRuntime"),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Accolades_LyraAccoladeHostWidget_h__Script_ShooterCoreRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Accolades_LyraAccoladeHostWidget_h__Script_ShooterCoreRuntime_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Accolades_LyraAccoladeHostWidget_h__Script_ShooterCoreRuntime_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_Accolades_LyraAccoladeHostWidget_h__Script_ShooterCoreRuntime_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
