...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FPlayerAssistDamageTracking;
class UScriptStruct* FPlayerAssistDamageTracking::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FPlayerAssistDamageTracking.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FPlayerAssistDamageTracking.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPlayerAssistDamageTracking, (UObject*)Z_Construct_UPackage__Script_ShooterCoreRuntime(), TEXT("PlayerAssistDamageTracking"));
	}
	return Z_Registration_Info_UScriptStruct_FPlayerAssistDamageTracking.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FPlayerAssistDamageTracking.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FPlayerAssistDamageTracking.InnerSingleton, Z_Construct_UScriptStruct_FPlayerAssistDamageTracking_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FPlayerAssistDamageTracking.InnerSingleton;
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UAssistProcessor;
UClass* UAssistProcessor::GetPrivateStaticClass()
{
	using TClass = UAssistProcessor;
	if (!Z_Registration_Info_UClass_UAssistProcessor.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("AssistProcessor"),
			Z_Registration_Info_UClass_UAssistProcessor.InnerSingleton,
			StaticRegisterNativesUAssistProcessor,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UAssistProcessor.InnerSingleton;
}
UClass* Z_Construct_UClass_UAssistProcessor_NoRegister()
{
	return UAssistProcessor::GetPrivateStaticClass();
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAssistProcessor_Statics::NewProp_DamageHistory_ValueProp = { "DamageHistory", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FPlayerAssistDamageTracking, METADATA_PARAMS(0, nullptr) }; // 199760944
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_MessageProcessors_AssistProcessor_h__Script_ShooterCoreRuntime_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FPlayerAssistDamageTracking::StaticStruct, Z_Construct_UScriptStruct_FPlayerAssistDamageTracking_Statics::NewStructOps, TEXT("PlayerAssistDamageTracking"), &Z_Registration_Info_UScriptStruct_FPlayerAssistDamageTracking, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPlayerAssistDamageTracking), 199760944U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAssistProcessor, UAssistProcessor::StaticClass, TEXT("UAssistProcessor"), &Z_Registration_Info_UClass_UAssistProcessor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssistProcessor), 2141867263U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_MessageProcessors_AssistProcessor_h__Script_ShooterCoreRuntime_2016994223(TEXT("/Script/ShooterCoreRuntime"),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_MessageProcessors_AssistProcessor_h__Script_ShooterCoreRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_MessageProcessors_AssistProcessor_h__Script_ShooterCoreRuntime_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_MessageProcessors_AssistProcessor_h__Script_ShooterCoreRuntime_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_MessageProcessors_AssistProcessor_h__Script_ShooterCoreRuntime_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
