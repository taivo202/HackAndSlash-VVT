...
FClassRegistrationInfo Z_Registration_Info_UClass_UShooterCoreRuntimeSettings;
UClass* UShooterCoreRuntimeSettings::GetPrivateStaticClass()
{
	using TClass = UShooterCoreRuntimeSettings;
	if (!Z_Registration_Info_UClass_UShooterCoreRuntimeSettings.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("ShooterCoreRuntimeSettings"),
			Z_Registration_Info_UClass_UShooterCoreRuntimeSettings.InnerSingleton,
			StaticRegisterNativesUShooterCoreRuntimeSettings,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UShooterCoreRuntimeSettings.InnerSingleton;
}
UClass* Z_Construct_UClass_UShooterCoreRuntimeSettings_NoRegister()
{
	return UShooterCoreRuntimeSettings::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_ShooterCoreRuntimeSettings_h__Script_ShooterCoreRuntime_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UShooterCoreRuntimeSettings, UShooterCoreRuntimeSettings::StaticClass, TEXT("UShooterCoreRuntimeSettings"), &Z_Registration_Info_UClass_UShooterCoreRuntimeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UShooterCoreRuntimeSettings), 4066512836U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_ShooterCoreRuntimeSettings_h__Script_ShooterCoreRuntime_3077657880(TEXT("/Script/ShooterCoreRuntime"),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_ShooterCoreRuntimeSettings_h__Script_ShooterCoreRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_ShooterCore_Source_ShooterCoreRuntime_Public_ShooterCoreRuntimeSettings_h__Script_ShooterCoreRuntime_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
