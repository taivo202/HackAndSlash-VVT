...
FClassRegistrationInfo Z_Registration_Info_UClass_ULyraCameraMode_TopDownArenaCamera;
UClass* ULyraCameraMode_TopDownArenaCamera::GetPrivateStaticClass()
{
	using TClass = ULyraCameraMode_TopDownArenaCamera;
	if (!Z_Registration_Info_UClass_ULyraCameraMode_TopDownArenaCamera.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("LyraCameraMode_TopDownArenaCamera"),
			Z_Registration_Info_UClass_ULyraCameraMode_TopDownArenaCamera.InnerSingleton,
			StaticRegisterNativesULyraCameraMode_TopDownArenaCamera,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_ULyraCameraMode_TopDownArenaCamera.InnerSingleton;
}
UClass* Z_Construct_UClass_ULyraCameraMode_TopDownArenaCamera_NoRegister()
{
	return ULyraCameraMode_TopDownArenaCamera::GetPrivateStaticClass();
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULyraCameraMode_TopDownArenaCamera_Statics::NewProp_BoundsSizeToDistance = { "BoundsSizeToDistance", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ULyraCameraMode_TopDownArenaCamera, BoundsSizeToDistance), Z_Construct_UScriptStruct_FRuntimeFloatCurve, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BoundsSizeToDistance_MetaData), NewProp_BoundsSizeToDistance_MetaData) }; // 3139605666
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_TopDownArena_Source_TopDownArenaRuntime_Public_LyraCameraMode_TopDownArenaCamera_h__Script_TopDownArenaRuntime_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ULyraCameraMode_TopDownArenaCamera, ULyraCameraMode_TopDownArenaCamera::StaticClass, TEXT("ULyraCameraMode_TopDownArenaCamera"), &Z_Registration_Info_UClass_ULyraCameraMode_TopDownArenaCamera, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraCameraMode_TopDownArenaCamera), 869489525U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_TopDownArena_Source_TopDownArenaRuntime_Public_LyraCameraMode_TopDownArenaCamera_h__Script_TopDownArenaRuntime_2434143741(TEXT("/Script/TopDownArenaRuntime"),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_TopDownArena_Source_TopDownArenaRuntime_Public_LyraCameraMode_TopDownArenaCamera_h__Script_TopDownArenaRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_TopDownArena_Source_TopDownArenaRuntime_Public_LyraCameraMode_TopDownArenaCamera_h__Script_TopDownArenaRuntime_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
