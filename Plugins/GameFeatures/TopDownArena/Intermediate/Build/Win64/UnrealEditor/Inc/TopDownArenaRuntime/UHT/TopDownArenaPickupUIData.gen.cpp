...
FClassRegistrationInfo Z_Registration_Info_UClass_UTopDownArenaPickupUIData;
UClass* UTopDownArenaPickupUIData::GetPrivateStaticClass()
{
	using TClass = UTopDownArenaPickupUIData;
	if (!Z_Registration_Info_UClass_UTopDownArenaPickupUIData.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("TopDownArenaPickupUIData"),
			Z_Registration_Info_UClass_UTopDownArenaPickupUIData.InnerSingleton,
			StaticRegisterNativesUTopDownArenaPickupUIData,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UTopDownArenaPickupUIData.InnerSingleton;
}
UClass* Z_Construct_UClass_UTopDownArenaPickupUIData_NoRegister()
{
	return UTopDownArenaPickupUIData::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_TopDownArena_Source_TopDownArenaRuntime_Private_TopDownArenaPickupUIData_h__Script_TopDownArenaRuntime_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UTopDownArenaPickupUIData, UTopDownArenaPickupUIData::StaticClass, TEXT("UTopDownArenaPickupUIData"), &Z_Registration_Info_UClass_UTopDownArenaPickupUIData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTopDownArenaPickupUIData), 2205841709U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_TopDownArena_Source_TopDownArenaRuntime_Private_TopDownArenaPickupUIData_h__Script_TopDownArenaRuntime_2620410141(TEXT("/Script/TopDownArenaRuntime"),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_TopDownArena_Source_TopDownArenaRuntime_Private_TopDownArenaPickupUIData_h__Script_TopDownArenaRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_TopDownArena_Source_TopDownArenaRuntime_Private_TopDownArenaPickupUIData_h__Script_TopDownArenaRuntime_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
