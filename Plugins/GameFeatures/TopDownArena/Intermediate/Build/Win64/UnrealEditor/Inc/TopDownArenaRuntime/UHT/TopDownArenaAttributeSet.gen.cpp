...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UTopDownArenaAttributeSet_OnRep_BombRange_Statics::NewProp_OldValue = { "OldValue", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(TopDownArenaAttributeSet_eventOnRep_BombRange_Parms, OldValue), Z_Construct_UScriptStruct_FGameplayAttributeData, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OldValue_MetaData), NewProp_OldValue_MetaData) }; // 1532612004
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UTopDownArenaAttributeSet_OnRep_MovementSpeed_Statics::NewProp_OldValue = { "OldValue", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(TopDownArenaAttributeSet_eventOnRep_MovementSpeed_Parms, OldValue), Z_Construct_UScriptStruct_FGameplayAttributeData, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OldValue_MetaData), NewProp_OldValue_MetaData) }; // 1532612004
...
FClassRegistrationInfo Z_Registration_Info_UClass_UTopDownArenaAttributeSet;
UClass* UTopDownArenaAttributeSet::GetPrivateStaticClass()
{
	using TClass = UTopDownArenaAttributeSet;
	if (!Z_Registration_Info_UClass_UTopDownArenaAttributeSet.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("TopDownArenaAttributeSet"),
			Z_Registration_Info_UClass_UTopDownArenaAttributeSet.InnerSingleton,
			StaticRegisterNativesUTopDownArenaAttributeSet,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UTopDownArenaAttributeSet.InnerSingleton;
}
UClass* Z_Construct_UClass_UTopDownArenaAttributeSet_NoRegister()
{
	return UTopDownArenaAttributeSet::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UTopDownArenaAttributeSet_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UTopDownArenaAttributeSet_OnRep_BombCapacity, "OnRep_BombCapacity" }, // 567092098
		{ &Z_Construct_UFunction_UTopDownArenaAttributeSet_OnRep_BombRange, "OnRep_BombRange" }, // 1875929388
		{ &Z_Construct_UFunction_UTopDownArenaAttributeSet_OnRep_BombsRemaining, "OnRep_BombsRemaining" }, // 1454985152
		{ &Z_Construct_UFunction_UTopDownArenaAttributeSet_OnRep_MovementSpeed, "OnRep_MovementSpeed" }, // 964359442
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_TopDownArena_Source_TopDownArenaRuntime_Private_TopDownArenaAttributeSet_h__Script_TopDownArenaRuntime_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UTopDownArenaAttributeSet, UTopDownArenaAttributeSet::StaticClass, TEXT("UTopDownArenaAttributeSet"), &Z_Registration_Info_UClass_UTopDownArenaAttributeSet, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTopDownArenaAttributeSet), 463575021U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_TopDownArena_Source_TopDownArenaRuntime_Private_TopDownArenaAttributeSet_h__Script_TopDownArenaRuntime_249487593(TEXT("/Script/TopDownArenaRuntime"),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_TopDownArena_Source_TopDownArenaRuntime_Private_TopDownArenaAttributeSet_h__Script_TopDownArenaRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_GameFeatures_TopDownArena_Source_TopDownArenaRuntime_Private_TopDownArenaAttributeSet_h__Script_TopDownArenaRuntime_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
