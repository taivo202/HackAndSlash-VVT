...
FClassRegistrationInfo Z_Registration_Info_UClass_UBPFunctionLibrary;
UClass* UBPFunctionLibrary::GetPrivateStaticClass()
{
	using TClass = UBPFunctionLibrary;
	if (!Z_Registration_Info_UClass_UBPFunctionLibrary.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("BPFunctionLibrary"),
			Z_Registration_Info_UClass_UBPFunctionLibrary.InnerSingleton,
			StaticRegisterNativesUBPFunctionLibrary,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UBPFunctionLibrary.InnerSingleton;
}
UClass* Z_Construct_UClass_UBPFunctionLibrary_NoRegister()
{
	return UBPFunctionLibrary::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UBPFunctionLibrary_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UBPFunctionLibrary_ChangeMeshMaterials, "ChangeMeshMaterials" }, // 2581116259
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_LyraExtTool_Source_LyraExtTool_Public_BPFunctionLibrary_h__Script_LyraExtTool_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBPFunctionLibrary, UBPFunctionLibrary::StaticClass, TEXT("UBPFunctionLibrary"), &Z_Registration_Info_UClass_UBPFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBPFunctionLibrary), 3571148235U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_LyraExtTool_Source_LyraExtTool_Public_BPFunctionLibrary_h__Script_LyraExtTool_242555816(TEXT("/Script/LyraExtTool"),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_LyraExtTool_Source_LyraExtTool_Public_BPFunctionLibrary_h__Script_LyraExtTool_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_LyraExtTool_Source_LyraExtTool_Public_BPFunctionLibrary_h__Script_LyraExtTool_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
