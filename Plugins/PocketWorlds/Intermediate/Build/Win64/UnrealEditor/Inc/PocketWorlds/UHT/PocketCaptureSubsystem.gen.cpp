...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPocketCaptureSubsystem_CreateThumbnailRenderer_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UPocketCaptureSubsystem, nullptr, "CreateThumbnailRenderer", Z_Construct_UFunction_UPocketCaptureSubsystem_CreateThumbnailRenderer_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPocketCaptureSubsystem_CreateThumbnailRenderer_Statics::PropPointers), sizeof(Z_Construct_UFunction_UPocketCaptureSubsystem_CreateThumbnailRenderer_Statics::PocketCaptureSubsystem_eventCreateThumbnailRenderer_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020403, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UPocketCaptureSubsystem_CreateThumbnailRenderer_Statics::Function_MetaDataParams), Z_Construct_UFunction_UPocketCaptureSubsystem_CreateThumbnailRenderer_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_UPocketCaptureSubsystem;
UClass* UPocketCaptureSubsystem::GetPrivateStaticClass()
{
	using TClass = UPocketCaptureSubsystem;
	if (!Z_Registration_Info_UClass_UPocketCaptureSubsystem.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("PocketCaptureSubsystem"),
			Z_Registration_Info_UClass_UPocketCaptureSubsystem.InnerSingleton,
			StaticRegisterNativesUPocketCaptureSubsystem,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UPocketCaptureSubsystem.InnerSingleton;
}
UClass* Z_Construct_UClass_UPocketCaptureSubsystem_NoRegister()
{
	return UPocketCaptureSubsystem::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UPocketCaptureSubsystem_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UPocketCaptureSubsystem_CreateThumbnailRenderer, "CreateThumbnailRenderer" }, // 2299739588
		{ &Z_Construct_UFunction_UPocketCaptureSubsystem_DestroyThumbnailRenderer, "DestroyThumbnailRenderer" }, // 728056490
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_PocketWorlds_Source_Public_PocketCaptureSubsystem_h__Script_PocketWorlds_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPocketCaptureSubsystem, UPocketCaptureSubsystem::StaticClass, TEXT("UPocketCaptureSubsystem"), &Z_Registration_Info_UClass_UPocketCaptureSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPocketCaptureSubsystem), 2023440369U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_PocketWorlds_Source_Public_PocketCaptureSubsystem_h__Script_PocketWorlds_2573707022(TEXT("/Script/PocketWorlds"),
	Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_PocketWorlds_Source_Public_PocketCaptureSubsystem_h__Script_PocketWorlds_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_iamatomic_Documents_Unreal_Projects_HackAndSlash_VoVanTai_Plugins_PocketWorlds_Source_Public_PocketCaptureSubsystem_h__Script_PocketWorlds_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
