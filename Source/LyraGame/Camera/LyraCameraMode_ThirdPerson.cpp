...
void ULyraCameraMode_ThirdPerson::UpdateView(float DeltaTime)
{
	...
	View.FieldOfView = View.FieldOfView;
	...
	else
	{
		...
		View.Location = PivotLocation + PivotRotation.RotateVector(TargetOffset * TargetCharacter->OffsetCameraWhenStartBattle);
	}

	View.Location = FMath::VInterpTo(PreviousDesiredPivotLocation, View.Location, DeltaTime, 20);

	PreviousDesiredPivotLocation = View.Location;
