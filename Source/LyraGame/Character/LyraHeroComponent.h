...
public:
	...
	void AddExtraAllowedTags(const FGameplayTagContainer& SourceTags);

	UFUNCTION(BlueprintCallable, Category = "Ability")
	void RemoveExtraAllowedTags(const FGameplayTagContainer& SourceTags);

	UFUNCTION(BlueprintCallable, Category = "Ability")
	bool DoesAbilityPassExtraAllowedTagsCheck(const FGameplayTagContainer& SourceTags);

	FGameplayTagStackContainer ExtraAllowedTags;
