...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnAbilitySystemComponentInitialized, ALyraCharacter*, Character);
...
public:
	...
	FOnAbilitySystemComponentInitialized OnASCInitializedEvent;
...
public:
	...
	TMap<FGameplayTag, FGameplayTagContainer> AllowAbilityTagTemplate;

public:
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	float OffsetCameraWhenStartBattle = 1.f;
};
